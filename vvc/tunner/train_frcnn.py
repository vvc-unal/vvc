...
from vvc.tunner import config as tunner_config

sys.setrecursionlimit(40000)

class FRCNNTunner(object):
...
def save_config(c, filename):
	...
	with open(filename, 'wb') as config_f:
...
if __name__ == '__main__':
	...
	elif options.parser == 'tf_pascal_voc':
		get_data = tf_pascal_voc_parser.get_data
	else:
	...
	save_config(C, options.config_filename)
